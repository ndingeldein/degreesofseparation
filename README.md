...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create degreesofseparation-a3c7
  fly apps create degreesofseparation-a3c7-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app degreesofseparation-a3c7
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app degreesofseparation-a3c7-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'degreesofseparation-a3c7-staging' does not match app name in config file 'degreesofseparation-a3c7'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name degreesofseparation-a3c7-db
  fly postgres attach --app degreesofseparation-a3c7 degreesofseparation-a3c7-db

  fly postgres create --name degreesofseparation-a3c7-staging-db
  fly postgres attach --app degreesofseparation-a3c7-staging degreesofseparation-a3c7-staging-db
  ```
